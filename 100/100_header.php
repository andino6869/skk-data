<?php
	function writeheader($strPageArea)
	{
		...
		echo "100-Jahre-Feier - ".$strPageArea.chr(13).chr(10);
		echo "</TITLE>".chr(13).chr(10);

		// Darstellung des Icons:
		echo "<HEAD>".chr(13).chr(10);

		if (is_file("pics/icons/100_jahre_feier.ico"))
		{
			echo "<link rel='shortcut icon' href='pics/icons/100_jahre_feier.ico' type='image/x-icon'>".chr(13).chr(10);
		}
		else
		{
		...
		// Stylesheet:
		echo "<LINK REL='stylesheet' HREF='skk_100.css'>".chr(13).chr(10);
		echo "<BODY topmargin='5' marginheight='0' bgcolor='#800000' marginwidth='0' leftmargin='0'>".chr(13).chr(10);
		...
		echo "<TR bgcolor=#800000>".chr(13).chr(10);
		echo "<TD WIDTH='25%'align='center'>".chr(13).chr(10);
		echo "<img border='0' src='pics/clublogo.gif' width=115 height=100 align='center'>".chr(13).chr(10);

		echo "</TD>".chr(13).chr(10);
		echo "<TD WIDTH='50%'>".chr(13).chr(10);
		echo "<p align='center'>".chr(13).chr(10);
		
		echo "<img border='0' src='pics/skk.png' width=500 height=105>".chr(13).chr(10);
