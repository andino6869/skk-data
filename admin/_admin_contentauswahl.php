...
<?php
	writeheader("Admin - Tabelle bearbeiten");
?>
...
<?php
	...
	echo "<form method=post action='_admin_contentaendern.php'>".chr(13).chr(10);
	...
	if ($num>0)
	{
		...
		if ($dx==1)
		{
			...
			echo "<I>W&auml;hlen Sie hier die Tabelle aus, die Sie bearbeiten m&ouml;chten. Die hier angezeigten Datens&auml;tze stammen aus der Tabelle 'skk_content' und sind nach dem Titel ".chr(13).chr(10);
		...
		echo "<BR><INPUT TYPE=submit Value='Tabelle bearbeiten'>".chr(13).chr(10);
	}
	else
	{
