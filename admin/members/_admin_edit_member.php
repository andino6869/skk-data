...
<?php
	...
	echo "keinen FIDE - Titel haben, dann wählen Sie bitte ".chr(34)."-".chr(34)." aus.'>";
	...
	echo "</td><td>";
  	...
  	// #########################################################
  	// Keine zusätzlichen Rechte für Normalanwender ermöglichen!
  	// UPDATE 23.10.2015:
	...
	{
		echo "<BR><BR>".chr(13).chr(10);
		echo "<I>Wird hier ein Ja gesetzt, dann können alle gr&ouml;&szlig;eren Eingabefelder ohne HTML - Kenntnisse &uuml;ber word&auml;hnliche Schaltfl&auml;chen bedient werden.</I>";
	}
