...
<?php
	...
	echo "<SPAN CLASS=he1>Kommentar bearbeiten (COMMENT - Tabelle)</SPAN><BR><BR>".chr(13).chr(10);
	echo "<form method=post action='_admin_edit_comment.php'>".chr(13).chr(10);
	...
	if ($RecordCount > 0)
	{
		...
		if ($dx==1)
		{
			echo "<BR><BR><I>Die hier angezeigten Datens&auml;tze stammen aus der Tabelle 'skk_comments' und sind nach dem Mamen des Melders aufsteigend sortiert.</I>";
		}
		...
		echo "<BR><INPUT TYPE=submit Value='Kommentar bearbeiten'>".chr(13).chr(10);
	}
	else
	{
