...
<?php
	...
	// #########################################################
	// 4.) Gab es Probleme beim Verbindungsaufbau?
	if ($objDBCon == "")
	{
	...
	// #########################################################
	// 5.) Ausgabe der Überschrift:
	echo "<SPAN CLASS=he1>Fotogalerien aus der aktuellen Saison</SPAN><BR><BR>".chr(13).chr(10);


	// #########################################################
	// 6.) Daten aus Datenbank holen:
	$strSQL = "select * from skk_galery WHERE galerydate > '".(string)$curYear."-09-01' AND modifieddate IS NULL AND ";
	$strSQL = $strSQL."del='N'";
	...
	// Archiv:
	echo "&nbsp; <A HREF='../sites/galery_archive.php' title='Folgen Sie bitte diesem Link, ";
	echo "um &auml;ltere Fotogalerien einzusehen.'><IMG SRC='../pics/icons/pfeilrotaufgelb.gif' BORDER=0> Archiv &auml;lterer Fotogalerien</A><BR>".chr(13).chr(10);
