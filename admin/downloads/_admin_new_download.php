...
<?php
	...
	// ##########
	// Die Datei:
	echo "<TR><TD width=".Chr(34)."100%".Chr(34)." bgcolor=".Chr(34)."#C0C0C0".Chr(34)."><B><U>Datei f&uuml;r Download: *</U></B>".chr(13).chr(10);
	...
	writeDateField("expire_day", "expire_month", "expire_year", "","","", "FALSE", "TRUE");
	...
	{
		echo "<BR><BR>".chr(13).chr(10);
		echo "<I>Beim Wert ".Chr(34)."Alle".Chr(34)." wird dieser Donwload generell angeboten, ansonsten nur auf der jeweiligen Seite!</I>".chr(13).chr(10);
	}
	echo "</TD></TR>".chr(13).chr(10);
	...
	echo "<OPTION Value=".Chr(34)."2".Chr(34).">100-Jahre-Feier".chr(13).chr(10);
	...
	echo "</TD></TR>".chr(13).chr(10);
	echo "<TR><TD width=".Chr(34)."100%".Chr(34)."><INPUT TYPE=Text style=".Chr(34)."width:100%".Chr(34)." NAME=viewname TITLE=".Chr(34)."Geben Sie hier die Beschreibung an, wie dieser Link im Browserfenster dann angezeigt werden soll.".Chr(34)." size=100></td></tr>".chr(13).chr(10);
