...
<?php
	writeheader("Admin - Kommentar l&ouml;schen - Check");
?>
...
<?php
	...
	$strSQL = "UPDATE skk_comments SET del='J', modifieddate='$now', modifier='$curUser' WHERE ID=$ID AND del='N' AND ";
	...
	{
		echo "Der Kommentar konnte nicht gel&ouml;scht werden!<BR>".chr(13).chr(10);
		echo mysqli_error($objDBCon).chr(13).chr(10);
		echo "<BR>Statement: " . $strSQL . "<BR>".chr(13).chr(10);
	}
	else
	{
  		echo "Der Kommentar wurde erfolgreich gel&ouml;scht.".chr(13).chr(10);
