...
<?php
	writeheader("Admin - Turnierdaten l&ouml;schen");
?>
...
<?php
	...
	// ##############################################
	echo "<SPAN CLASS=he1>Turnierdaten L&ouml;schen (TOURNAMENT - Tabelle)</SPAN><BR><BR>".chr(13).chr(10);
	echo "<form method=post action='_admin_del_tournament_ok.php'>".chr(13).chr(10);
	...
	if ($RecordCount > 0)
	{
		...
		if ($dx==1)
		{
			...
			echo "<I>W&auml;hlen Sie hier das Turnier aus, die Sie l&ouml;schen m&ouml;chten. Die hier angezeigten Datens&auml;tze stammen aus der Tabelle 'skk_tournaments' und sind nach dem Turnier ".chr(13).chr(10);
		...
		echo "<BR><INPUT TYPE=submit Value='Turnier l&ouml;schen'>".chr(13).chr(10);
	}
	else
	{
		echo "<BR><B>Hinweis:</B><BR><BR>".chr(13).chr(10);
		echo "In der Tabelle 'skk_torunaments' befinden sich derzeit keine bearbeitbaren Datens&auml;tze.<BR>".chr(13).chr(10);
	}
