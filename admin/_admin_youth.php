...
<?php
	writeheader("Admin - Jugend bearbeiten", "TRUE");
?>
...
<?php
	...
	$objectclassicon = "youth.gif";
	include("forms/objectclassicon.php");
	echo "<SPAN CLASS=he1>'Jugendseite' bearbeiten (YOUTH - Tabelle)</SPAN><BR><BR>".chr(13).chr(10);

	// Die Daten aus der Datenbank ermitteln:
	$strSQL ="select text from skk_youth WHERE del='N' AND modifieddate IS NULL;";
	...
	echo "<FORM METHOD=POST ACTION='_admin_youth_ok.php'>".chr(13).chr(10);
	...
	{
		echo "<BR><BR>".chr(13).chr(10);
		echo "<I>Geben Sie hier den Inhalt der Seite Jugend ein. Es sind alle g&auml;ngigen HTML - Tags zugelassen. ".chr(13).chr(10);
		echo "Ferner k&ouml;nnen nun auch die Zeichen ' und \" im Text verwendet werden.</I>";
	}
	echo "</TD></TR>".chr(13).chr(10);

	// SAusgabe des Seiteninhalts:
	$strItem = $Text[0];
	...
	echo "<BR><INPUT TYPE=Submit VALUE='Inhalt speichern'>".chr(13).chr(10);
