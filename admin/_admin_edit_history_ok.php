...
<?php
	writeheader("Admin - Vereinsgeschichte bearbeiten - Check");
?>
...
<?php
	...
	else
	{
		...
		// Der UPDATE:
		$strSQL = "UPDATE skk_history SET modifieddate='$now', modifier='$curUser' WHERE del='N' ";
		...
		{
			echo "Die Vereinsgeschichtsseite wurde erfolgreich aktualisiert.<BR><BR>".chr(13).chr(10);
