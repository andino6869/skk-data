...
<?php
	...
	$strSQL = "SELECT text FROM skk_afro_hotel WHERE del='N' AND modifieddate IS NULL AND text IS NOT NULL;";
	...
	{
		echo "Es sind derzeit keine <B>Hoteldaten</B> für das nächste Augsburger Friedensfest Schachopen (AFRO) hinterlegt.".chr(13).chr(10);
	}
