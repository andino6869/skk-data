...
<?php
	...
	$strSQL = "SELECT text FROM skk_afro_results WHERE del='N' AND modifieddate IS NULL AND text IS NOT NULL;";
	...
	{
		echo "Es sind derzeit keine <B>Ergebnisdaten</B> für die Augsburger Friedensfest Schachopens (AFRO´s) hinterlegt.".chr(13).chr(10);
	}
