<?php
	...
	echo "<TR><TD font color='#FFFFFF' bgcolor='#EEEEEE' align='center'>".chr(13).chr(10);
	...
	$strSQL = "SELECT numberofhits FROM skk_afro_hits WHERE del='N' AND curYear=".$curYear." AND modifieddate IS NULL;";
	...
	if ($RecordCount > 0)
	{
		...
		if ($RecordCount > 0)
		{
			...
			echo "<BR>Anzahl der Zugriffe seit ";
